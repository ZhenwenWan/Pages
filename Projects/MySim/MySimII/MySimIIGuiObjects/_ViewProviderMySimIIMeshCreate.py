...
class _TaskPanelMySimIIMeshCreate:
    ...
    def __init__(self, obj):
        ...
        self.obj = obj
        self.GroupList = obj.MeshGroupList
        self.VaryingList = obj.MeshBoundaryLayerList
        self.FixedList = obj.MeshRegionList
    ...
    def init_form(self):
        ...
        for obj in FreeCAD.ActiveDocument.Objects:
            if obj.isDerivedFrom("MySimII::FeaturePython") and ("Boundary" in obj.Label or "Material" in obj.Label ):
                Rows += 1
        ...
        Rows = 0
        for obj in FreeCAD.ActiveDocument.Objects:
            if obj.isDerivedFrom("MySimII::FeaturePython") and "Varying" in str(obj.Label):
                Rows += 1
        ...
        Rows = 0
        for obj in FreeCAD.ActiveDocument.Objects:
            if obj.isDerivedFrom("MySimII::FeaturePython") and "MeshFixed" in str(obj.Label):
                Rows += 1
