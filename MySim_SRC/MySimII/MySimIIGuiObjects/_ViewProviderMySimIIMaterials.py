...
class _ViewProviderMySimIIMaterials:
    ...
    def setEdit(self, vobj, mode):
        ...
        for o in FreeCAD.ActiveDocument.Objects:
            if o.isDerivedFrom("MySimII::MySimIIMaterialsObject") and not (o == self.Object):
                o.ViewObject.hide()
...
class _TaskPanelMySimIIMaterials:
    ...
    def __init__(self, obj):
        ...
        self.form0.MaterialName.addItems(
            _MySimIIMaterials._MySimIIMaterials.MaterialNames
        )
        self.form0.Unit.addItems(
            _MySimIIMaterials._MySimIIMaterials.Units
        )
    ...
    def update_ui(self):
        "filling the widget"
        index = self.form0.MaterialName.findText(self.MaterialName)
        self.form0.MaterialName.setCurrentIndex(index)
    ...
    def Name_chosen(self, index):
        if index < 0:
            return
        self.form0.MaterialName.setCurrentIndex(index)
        self.MaterialName = str(self.form0.MaterialName.itemText(index))
