#ifndef MYSIMGUI_MESHVIEW_H
#define MYSIMGUI_MESHVIEW_H
#include <memory>
...
{
	class MeshView :public QDialog
	{
		Q_OBJECT//
	public:
		MeshView(QDialog *parent = 0);
		~MeshView();
	protected:

		private Q_SLOTS :
		void OneFace(int faceNo);
		void MultiFacesView();
		void MeshAll();
		void MeshAndModel();
		void CheckedEnable();
