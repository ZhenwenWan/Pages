...
## @package MySimIIForces
#  \ingroup MySimII
#  \brief FreeCAD MySimII _MySimIIForces

import FreeCAD


class _MySimIIForces():
    """The MySimII::MySimIIForces's Proxy python type, add properties definition
    """

    ForceNames = ["Gravity", "EM force", "Coriolis", "Floating"]
    ...
    def __init__(self, obj):
        ...
        obj.ForceName = _MySimIIForces.ForceNames
        obj.ForceName = "EM force"
