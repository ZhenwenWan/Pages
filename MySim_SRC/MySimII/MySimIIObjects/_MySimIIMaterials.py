...
#  \ingroup MySimII
#  \brief FreeCAD MySimII _MySimIIMaterials

import FreeCAD


class _MySimIIMaterials():
    """The MySimII::MySimIIMaterials's Proxy python type, add properties definition
    """

    MaterialNames = ["Density", "Viscosity", "Impedance", "Elasticity"]
    Units = ["kg/m'3", "N/m'2", "Ohm", "Pa"]

    def __init__(self, obj):
        self.Type = "MySimII::MySimIIMaterials"
        ...
        obj.MaterialName = _MySimIIMaterials.MaterialNames
        obj.MaterialName = "Impedance"
        ...
        obj.Unit = _MySimIIMaterials.Units
        obj.Unit = "Ohm"
