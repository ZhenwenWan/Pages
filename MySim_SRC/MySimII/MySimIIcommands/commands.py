...
class _Initiatives(CommandManager):
    ...
    def __init__(self):
        ...
        self.resources = {
            ...
            "MenuText": QtCore.QT_TRANSLATE_NOOP("MySimII_Initiatives","我们"),
            "Accel":    "N, A",
    ...
    def Activated(self):
        ...
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIInitiativesObjectPython", "Initiative")
...
class _Forces(CommandManager):
    ...
    def __init__(self):
        ...
        self.resources = {
            "Pixmap":   "materials.svg",
            "MenuText": QtCore.QT_TRANSLATE_NOOP("MySimII_Forces","Forces"),
            "Accel":    "N, A",
            "ToolTip":  QtCore.QT_TRANSLATE_NOOP("MySimII_Forces","Forces")}
        self.is_active = "with_document"

    def Activated(self):
        FreeCAD.ActiveDocument.openTransaction("Create Forces")
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIForcesObjectPython", "Force")
...
class _Materials(CommandManager):
    ...
    def Activated(self):
        ...
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIMaterialsObjectPython", "Material")
...
class _Boundaries(CommandManager):
    ...
    def Activated(self):
        ...
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIBoundariesObjectPython", "Boundary")
...
class _MeshBoundaries(CommandManager):
    ...
    def Activated(self):
        ...
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIMeshBoundariesObjectPython", "MeshVarying")
...
class _MeshNodes(CommandManager):
    "The MySimII_MeshNodes command definition"

    def __init__(self):
        super(_MeshNodes, self).__init__()
        self.resources = {
            "Pixmap":   "materials.svg",
            "MenuText": QtCore.QT_TRANSLATE_NOOP("MySimII_MeshNodes","Labeling"),
            "Accel":    "N, A",
            "ToolTip":  QtCore.QT_TRANSLATE_NOOP("MySimII_MeshNodes","Labeling")}
        self.is_active = "always"

    def Activated(self):
        FreeCAD.ActiveDocument.openTransaction("Create MeshNode")
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIMeshNodesObjectPython", "MeshGroup")
        from MySimIIObjects import _MySimIIMeshNodes
        _MySimIIMeshNodes._MySimIIMeshNodes(obj)
        if FreeCAD.GuiUp:
            from MySimIIGuiObjects import _ViewProviderMySimIIMeshNodes
            _ViewProviderMySimIIMeshNodes._ViewProviderMySimIIMeshNodes(obj.ViewObject)
        FreeCADGui.ActiveDocument.setEdit(obj.Name)
        FreeCADGui.Selection.clearSelection()
        FreeCAD.ActiveDocument.recompute()
...
class _MeshRegions(CommandManager):
    ...
    def Activated(self):
        ...
        obj = FreeCAD.ActiveDocument.addObject("MySimII::MySimIIMeshRegionsObjectPython", "MeshFixed")
...
class _MeshCreate(CommandManager):
    ...
    def __init__(self):
        ...
        self.resources = {
            "Pixmap":   "materials.svg",
            "MenuText": QtCore.QT_TRANSLATE_NOOP("MySimII_MeshCreate","Create"),
            "Accel":    "N, A",
            "ToolTip":  QtCore.QT_TRANSLATE_NOOP("MySimII_MeshCreate","Create")}
        self.is_active = "always"
